...
output "eks_cluster_arn" {
  ...
  value       = module.project_eks_cluster.cluster_arn
}
...
output "eks_cluster_oidc_issuer_url" {
  ...
  value       = module.project_eks_cluster.cluster_oidc_issuer_url #
}
...
output "eks_node_group_autoscaling_group_names" {
  ...
  value       = module.project_eks_cluster.eks_managed_node_groups_autoscaling_group_names
}

output "repository_arn" {
  value       = module.project_ecr_repository.repository_arn
