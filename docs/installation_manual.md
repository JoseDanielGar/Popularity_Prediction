...
Debido a que el despliegue se ejecutó sobre una cuenta de AWS académica y con limite de acceso por tiempo, se debe solicitar la URL a los responsables del proyecto.
